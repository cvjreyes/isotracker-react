...
const MenuList = () =>{
    ...
    const [equipIsShown, setEquipIsoIsShown] = useState(false);
    const [civIsShown, setCivIsoIsShown] = useState(false);
    const [instIsShown, setInstIsoIsShown] = useState(false);
    const [elecIsShown, setElecIsoIsShown] = useState(false);

    var isoHover;

    if (isoIsShown){
        isoHover = <a href="/" style={{textDecoration: "none"}}>
                        <h4 style={{backgroundColor: "lightgray"}} className="panel__icon__container" onMouseEnter={() => setIsoIsShown(true)} onMouseLeave={() => setIsoIsShown(false)} ><img src={FileIcon} alt="file" className="panel__icon"/>&nbsp;&nbsp;&nbsp;IsoTracker</h4>
                        <div className="progress__bar" role="progressbar" aria-valuenow="70" aria-valuemin="0" aria-valuemax="100">
                            <span class="sr-only"></span>Open
                        </div>
                    </a>  
    }else{
        isoHover = <a href="/" style={{textDecoration: "none"}}>
    ...
    return(
        <div class="panel__container">
            ...
            <div className="panel__content__container">
                <div>
                    <a href="/" style={{textDecoration: "none"}}>
                        <h4 className="panel__icon__container"><img src={ChartColorIcon} alt="chart" className="panel__icon"/>&nbsp;&nbsp;&nbsp;3D Progress (Weight: 47688 | 100%)</h4>
                    </a>
                    <div class="progress" style={{marginTop:"25px", height: "25px"}}>
            ...
            <div className="panel__content__container">
                <div>
                    <a href="/" style={{textDecoration: "none"}}>
                        <h4 className="panel__icon__container"><img src={PipeIcon} alt="pipe" className="panel__icon"/>&nbsp;&nbsp;&nbsp;Piping (Weight: 20582 | 43.18%)</h4>        
                    </a>
                    <div class="progress" style={{marginTop:"25px", height: "25px"}}>
            ...
            <div className="panel__content__container">
                <div>
                    <a href="/" style={{textDecoration: "none"}}>
                        <h4 className="panel__icon__container"><img src={EquiIcon} alt="equi" className="panel__icon"/>&nbsp;&nbsp;&nbsp;Equipment (Weight: 4225 | 8.86%)</h4>                   
                    </a>
                    <div class="progress" style={{marginTop:"25px", height: "25px"}}>
            ...
            <div className="panel__content__container">
                <div>
                    <a href="/" style={{textDecoration: "none"}}>
                        <h4 className="panel__icon__container"><img src={StruIcon} alt="stru" className="panel__icon"/>&nbsp;&nbsp;&nbsp;Civil (Weight: 16730 | 35.1%)</h4> 
                    </a>
                    <div class="progress" style={{marginTop:"25px", height: "25px"}}>
            ...
            <div className="panel__content__container">
                <div>
                    <a href="/" style={{textDecoration: "none"}}>
                        <h4 className="panel__icon__container"><img src={InstIcon} className="panel__icon"/>&nbsp;&nbsp;&nbsp;Instrumentation (Weight: 1886 | 3.96%)</h4>         
                    </a>
                    <div class="progress" style={{marginTop:"25px", height: "25px"}}>
            ...
            <div className="panel__content__container__last">
                <div>
                    <a href="/" style={{textDecoration: "none"}}>
                        <h4 className="panel__icon__container"><img src={ElecIcon} className="panel__icon"/>&nbsp;&nbsp;&nbsp;Electrical (Weight: 4245 | 8.91%)</h4>
                    </a>
                    <div class="progress" style={{marginTop:"25px", height: "25px"}}>
