                ...
                <div>
                    <Modal visible={this.state.visible} width="1100" height="500" effect="fadeInUp" onClickAway={() => this.closeModal()}>
                        <div className="header__container">
                            ...
                            <h4 className="cancel__header__tray">Tray</h4>
                            <h4 className="cancel__header__comments">Comments</h4>
                        </div>
                        <div className="body__container">
                            <p className="isometric__name">021A1971101N0004_01.pdf</p>
                            <select className="destination__select" ><option value="Design" selected="selected">Design</option><option value="Stress">Stress</option><option value="Support">Support</option><option value="Materials">Materials</option><option value="Issuer">Issuer</option></select>
