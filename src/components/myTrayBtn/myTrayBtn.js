...
const MyTrayBtn = props =>{
    ...
    if(props.currentTab === "My Tray"){
        ...
        myTrayBtn = <button  type="button" class="btn btn-info btn-lg" style={{marginRight:"10px", width: "180px", backgroundColor: "lightblue"}} onClick={() => {props.onChange("My Tray")}}><b>My tray</b></button>
    }
    return(
