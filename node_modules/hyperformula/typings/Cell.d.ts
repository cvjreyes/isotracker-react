...
export declare class CellError {
    ...
    readonly address?: SimpleCellAddress | undefined;
    constructor(type: ErrorType, message?: string | undefined, address?: SimpleCellAddress | undefined);
    attachAddress(address: SimpleCellAddress): CellError;
