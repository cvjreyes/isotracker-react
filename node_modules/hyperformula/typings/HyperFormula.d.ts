...
import { AddressMapping, DependencyGraph, Graph, MatrixMapping, RangeMapping, SheetMapping, Vertex } from './DependencyGraph';
...
export declare class HyperFormula implements TypedEmitter {
     ...
     * @internal
     */
    get matrixMapping(): MatrixMapping;
    /**
     ...
     * @category Factories
     */
    static buildFromArray(sheet: Sheet, configInput?: Partial<ConfigParams>): HyperFormula;
    /**
     ...
     * @category Factories
     */
    static buildFromSheets(sheets: Sheets, configInput?: Partial<ConfigParams>): HyperFormula;
    /**
     ...
     * @category Factories
     */
    static buildEmpty(configInput?: Partial<ConfigParams>): HyperFormula;
     ...
     * @category Cells
     */
    getCellFormula(cellAddress: SimpleCellAddress): Maybe<string>;
    /**
     ...
     * @category Sheets
     */
    getSheetFormulas(sheetId: number): Maybe<string>[][];
    /**
     ...
     * @category Cells
     */
    isItPossibleToSetCellContents(topLeftCornerAddress: SimpleCellAddress, width?: number, height?: number): boolean;
    /**
     ...
     * @category Columns
     */
    isItPossibleToSetColumnOrder(sheetId: number, newRowOrder: number[]): boolean;
    /**
     ...
     * @category Cells
     */
    isItPossibleToMoveCells(sourceLeftCorner: SimpleCellAddress, width: number, height: number, destinationLeftCorner: SimpleCellAddress): boolean;
    /**
     ...
     * @category Cells
     */
    moveCells(sourceLeftCorner: SimpleCellAddress, width: number, height: number, destinationLeftCorner: SimpleCellAddress): ExportedChange[];
    /**
     ...
     * @category Clipboard
     */
    copy(sourceLeftCorner: SimpleCellAddress, width: number, height: number): CellValue[][];
    /**
     ...
     * @category Clipboard
     */
    cut(sourceLeftCorner: SimpleCellAddress, width: number, height: number): CellValue[][];
    /**
     ...
     * @category Ranges
     */
    getRangeValues(leftCorner: SimpleCellAddress, width: number, height: number): CellValue[][];
    /**
     ...
     * @category Ranges
     */
    getRangeFormulas(leftCorner: SimpleCellAddress, width: number, height: number): Maybe<string>[][];
    /**
     ...
     * @category Ranges
     */
    getRangeSerialized(leftCorner: SimpleCellAddress, width: number, height: number): RawCellContent[][];
    /**
     ...
     * @category Sheets
     */
    isItPossibleToRemoveSheet(sheetName: string): boolean;
    /**
     ...
     * @category Sheets
     */
    removeSheet(sheetName: string): ExportedChange[];
    /**
     ...
     * @category Sheets
     */
    isItPossibleToClearSheet(sheetName: string): boolean;
    /**
     ...
     * @category Sheets
     */
    clearSheet(sheetName: string): ExportedChange[];
    /**
     ...
     * @category Sheets
     */
    isItPossibleToReplaceSheetContent(sheetName: string, values: RawCellContent[][]): boolean;
    /**
     ...
     * @category Sheets
     */
    setSheetContent(sheetName: string, values: RawCellContent[][]): ExportedChange[];
    /**
     ...
     * @category Helpers
     */
    simpleCellAddressFromString(cellAddress: string, sheetId: number): Maybe<SimpleCellAddress>;
    /**
     ...
     * @category Helpers
     */
    simpleCellAddressToString(cellAddress: SimpleCellAddress, sheetId: number): Maybe<string>;
    /**
     ...
     * @category Helpers
     */
    getCellDependents(address: SimpleCellAddress | AbsoluteCellRange): (AbsoluteCellRange | SimpleCellAddress)[];
    /**
     ...
     * @category Helpers
     */
    getCellPrecedents(address: SimpleCellAddress | AbsoluteCellRange): (AbsoluteCellRange | SimpleCellAddress)[];
    /**
     ...
     * @category Sheets
     */
    getSheetId(sheetName: string): Maybe<number>;
    /**
     ...
     * @category Cells
     */
    isCellPartOfMatrix(cellAddress: SimpleCellAddress): boolean;
    /**
     ...
     */
    isItPossibleToAddNamedExpression(expressionName: string, expression: RawCellContent, scope?: string): boolean;
    /**
     ...
     * @category Named Expressions
     */
    addNamedExpression(expressionName: string, expression: RawCellContent, scope?: string, options?: NamedExpressionOptions): ExportedChange[];
    /**
     ...
     * @category Named Expressions
     */
    getNamedExpressionValue(expressionName: string, scope?: string): Maybe<CellValue>;
    /**
     ...
     * @category Named Expressions
     */
    getNamedExpressionFormula(expressionName: string, scope?: string): Maybe<string>;
    /**
     ...
     * @category Named Expressions
     */
    getNamedExpression(expressionName: string, scope?: string): Maybe<NamedExpression>;
    /**
     ...
     * @category Named Expressions
     */
    isItPossibleToChangeNamedExpression(expressionName: string, newExpression: RawCellContent, scope?: string): boolean;
    /**
     ...
     * @category Named Expressions
     */
    changeNamedExpression(expressionName: string, newExpression: RawCellContent, scope?: string, options?: NamedExpressionOptions): ExportedChange[];
    /**
     ...
     * @category Named Expressions
     */
    isItPossibleToRemoveNamedExpression(expressionName: string, scope?: string): boolean;
    /**
     ...
     * @category Named Expressions
     */
    removeNamedExpression(expressionName: string, scope?: string): ExportedChange[];
    /**
     ...
     * @category Named Expressions
     */
    listNamedExpressions(scope?: string): string[];
    /**
     ...
     * @category Helpers
     */
    calculateFormula(formulaString: string, sheetName: string): CellValue;
    /**
     ...
     * @category Helpers
     */
    numberToDateTime(val: number): DateTime;
    /**
     ...
     * @category Helpers
     */
    numberToDate(val: number): DateTime;
    /**
     ...
     * @category Helpers
     */
    numberToTime(val: number): DateTime;
