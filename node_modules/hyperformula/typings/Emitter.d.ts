...
export declare class Emitter extends TinyEmitter implements TypedEmitter {
    emit<Event extends keyof Listeners>(event: Event, ...args: Parameters<Listeners[Event]>): this;
}
