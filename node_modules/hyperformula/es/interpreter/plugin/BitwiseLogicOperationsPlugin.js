...
export var BitwiseLogicOperationsPlugin = /*#__PURE__*/function (_FunctionPlugin) {
  ...
  _createClass(BitwiseLogicOperationsPlugin, [{
    ...
    value: function bitand(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('BITAND'), function (left, right) {
        return left & right;
      });
    }
  }, {
    ...
    value: function bitor(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('BITOR'), function (left, right) {
        return left | right;
      });
    }
  }, {
    ...
    value: function bitxor(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('BITXOR'), function (left, right) {
        return left ^ right;
      });
    }
  }]);
