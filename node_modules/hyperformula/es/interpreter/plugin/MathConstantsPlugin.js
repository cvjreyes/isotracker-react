...
export var PI = parseFloat(Math.PI.toFixed(14));
export var MathConstantsPlugin = /*#__PURE__*/function (_FunctionPlugin) {
  ...
  _createClass(MathConstantsPlugin, [{
    ...
    value: function pi(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('PI'), function () {
        return PI;
      });
    }
  }, {
    key: "sqrtpi",
    value: function sqrtpi(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('SQRTPI'), function (arg) {
