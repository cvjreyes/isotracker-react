...
export var FinancialPlugin = /*#__PURE__*/function (_FunctionPlugin) {
  ...
  _createClass(FinancialPlugin, [{
    ...
    key: "fvschedule",
    value: function fvschedule(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('FVSCHEDULE'), function (value, ratios) {
    ...
    key: "npv",
    value: function npv(ast, formulaAddress) {
      var _this4 = this;

      return this.runFunction(ast.args, formulaAddress, this.metadata('NPV'), function (rate) {
    ...
    key: "mirr",
    value: function mirr(ast, formulaAddress) {
      var _this5 = this;

      return this.runFunction(ast.args, formulaAddress, this.metadata('MIRR'), function (range, frate, rrate) {
    ...
    key: "pduration",
    value: function pduration(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('PDURATION'), function (rate, pv, fv) {
        return (Math.log(fv) - Math.log(pv)) / Math.log(1 + rate);
      });
    }
  }, {
    key: "xnpv",
    value: function xnpv(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('XNPV'), function (rate, values, dates) {
