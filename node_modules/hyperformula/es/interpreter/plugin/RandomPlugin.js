...
export var RandomPlugin = /*#__PURE__*/function (_FunctionPlugin) {
  ...
  _createClass(RandomPlugin, [{
     ...
     */
    function rand(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('RAND'), Math.random);
    }
  }, {
    key: "randbetween",
    value: function randbetween(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('RANDBETWEEN'), function (lower, upper) {
        if (upper < lower) {
