...
export var CharPlugin = /*#__PURE__*/function (_FunctionPlugin) {
  ...
  _createClass(CharPlugin, [{
    ...
    value: function char(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('CHAR'), function (value) {
    ...
    key: "unichar",
    value: function unichar(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('CHAR'), function (value) {
