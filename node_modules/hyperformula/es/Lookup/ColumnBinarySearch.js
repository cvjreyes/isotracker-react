...
export var ColumnBinarySearch = /*#__PURE__*/function (_AdvancedFind) {
  ...
  _createClass(ColumnBinarySearch, [{
    ...
    value: function find(key, range, sorted) {
      ...
      if (range.height() < this.config.binarySearchThreshold || !sorted) {
        var values = this.dependencyGraph.computeListOfValuesInRange(range).map(getRawValue).map(function (arg) {
          return typeof arg === 'string' ? forceNormalizeString(arg) : arg;
        });
