  ...
  _createClass(CellContentParser, [{
    ...
    value: function parse(content) {
      if (content === undefined || content === null) {
        ...
        return new CellContent.Number(new _InterpreterValue.DateNumber(this.dateHelper.dateToNumber({
          day: content.getDate(),
        ...
        if (isBoolean(content)) {
          ...
          var val = this.numberLiteralsHelper.numericStringToMaybeNumber(trimmedContent);
