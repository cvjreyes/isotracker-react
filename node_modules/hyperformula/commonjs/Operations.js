  ...
  _createClass(Operations, [{
    ...
    value: function setCellContent(address, newCellContent) {
      ...
      if (vertex instanceof _DependencyGraph.MatrixVertex && !vertex.isFormula() && parsedCellContent instanceof _CellContentParser.CellContent.Number) {
        ...
        vertex.setMatrixCellValue(address, (0, _InterpreterValue.getRawValue)(newValue));
        this.columnSearch.change((0, _InterpreterValue.getRawValue)(oldValue), (0, _InterpreterValue.getRawValue)(newValue), address);
    ...
    value: function adjustNamedExpressionEdges(namedExpression, expressionName, sheetId) {
      ...
      try {
        for (_iterator11.s(); !(_step11 = _iterator11.n()).done;) {
          ...
          if (adjacentNode instanceof _DependencyGraph.FormulaCellVertex && adjacentNode.cellAddress.sheet === sheetId) {
            ...
            var _iterator12 = _createForOfIteratorHelper((0, _absolutizeDependencies.absolutizeDependencies)(dependencies, formulaAddress)),
                _step12;
    ...
    value: function updateNamedExpressionsForTargetAddress(sourceSheet, targetAddress, dependencies) {
      ...
      var _iterator14 = _createForOfIteratorHelper((0, _absolutizeDependencies.absolutizeDependencies)(dependencies, targetAddress)),
          _step14;
