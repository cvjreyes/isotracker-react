  ...
  _createClass(DateTimePlugin, [{
    ...
    value: function date(ast, formulaAddress) {
      ...
      return this.runFunction(ast.args, formulaAddress, this.metadata('DATE'), function (year, month, day) {
        ...
        if (_this2.interpreter.dateHelper.isValidDate(date)) {
          ...
          ret = _this2.interpreter.dateHelper.getWithinBounds(ret);
    ...
    value: function eomonth(ast, formulaAddress) {
      ...
      return this.runFunction(ast.args, formulaAddress, this.metadata('EOMONTH'), function (dateNumber, numberOfMonthsToShift) {
        ...
        var ret = _this3.interpreter.dateHelper.dateToNumber(_this3.interpreter.dateHelper.endOfMonth((0, _DateTimeHelper.offsetMonth)(date, numberOfMonthsToShift)));

        ret = _this3.interpreter.dateHelper.getWithinBounds(ret);
    ...
    value: function text(ast, formulaAddress) {
      ...
      return this.runFunction(ast.args, formulaAddress, this.metadata('TEXT'), function (numberRepresentation, formatArg) {
        return (0, _format.format)(numberRepresentation, formatArg, _this7.config, _this7.interpreter.dateHelper);
      });
    }
  }, {
    key: "weekday",
    ...
    value: function datevalue(ast, formulaAddress) {
      ...
      return this.runFunction(ast.args, formulaAddress, this.metadata('DATEVALUE'), function (date) {
        var _this10$interpreter$d = _this10.interpreter.dateHelper.parseDateTimeFromConfigFormats(date),
            dateTime = _this10$interpreter$d.dateTime;
        ...
        return ((0, _DateTimeHelper.instanceOfSimpleTime)(dateTime) ? Math.trunc((0, _DateTimeHelper.timeToNumber)(dateTime)) : 0) + _this10.interpreter.dateHelper.dateToNumber(dateTime);
      });
    }
  }, {
    key: "timevalue",
    ...
    value: function edate(ast, formulaAddress) {
      ...
      return this.runFunction(ast.args, formulaAddress, this.metadata('EDATE'), function (dateNumber, delta) {
        ...
        ret = _this14.interpreter.dateHelper.getWithinBounds(ret);
    ...
    key: "interval",
    value: function interval(ast, formulaAddress) {
      return this.runFunction(ast.args, formulaAddress, this.metadata('INTERVAL'), function (arg) {
        arg = Math.trunc(arg);
        var second = arg % 60;
    ...
    key: "networkdays",
    value: function networkdays(ast, formulaAddress) {
      var _this17 = this;

      return this.runFunction(ast.args, formulaAddress, this.metadata('NETWORKDAYS'), function (start, end, holidays) {
        return _this17.networkdayscore(start, end, 1, holidays);
      });
    }
  }, {
    key: "networkdaysintl",
    value: function networkdaysintl(ast, formulaAddress) {
      var _this18 = this;

      return this.runFunction(ast.args, formulaAddress, this.metadata('NETWORKDAYS.INTL'), function (start, end, weekend, holidays) {
        return _this18.networkdayscore(start, end, weekend, holidays);
      });
    }
  }, {
    key: "workday",
    value: function workday(ast, formulaAddress) {
      var _this19 = this;

      return this.runFunction(ast.args, formulaAddress, this.metadata('WORKDAY'), function (start, end, holidays) {
        return _this19.workdaycore(start, end, 1, holidays);
      });
    }
  }, {
    key: "workdayintl",
    value: function workdayintl(ast, formulaAddress) {
      var _this20 = this;

      return this.runFunction(ast.args, formulaAddress, this.metadata('WORKDAY.INTL'), function (start, end, weekend, holidays) {
    ...
    value: function networkdayscore(start, end, weekend, holidays) {
      ...
      var filteredHolidays = this.simpleRangeToFilteredHolidays(holidays, weekendPattern);
    ...
    value: function countWorkdays(start, end, weekendPattern, sortedHolidays) {
      var absoluteEnd = Math.floor(this.interpreter.dateHelper.relativeNumberToAbsoluteNumber(end));
      var absoluteStart = Math.floor(this.interpreter.dateHelper.relativeNumberToAbsoluteNumber(start));
      var ans = 0;
    ...
    value: function simpleRangeToFilteredHolidays(holidays, weekendPattern) {
      var _this21 = this;
      ...
      return _toConsumableArray(new Set(processedHolidays)).sort(function (a, b) {
        ...
        var val = _this21.interpreter.dateHelper.relativeNumberToAbsoluteNumber(arg);
